...
def register_data_tools(mcp):
    ...
    @mcp.tool()
    async def create_object(workspace_id: str, path: str, object_dict: dict) -> dict:
    ...
    async def get_object_content(
        workspace_id: str, object_id: str = "", object_path: str = "", version: str = ""
    ) -> dict:
    ...
    @mcp.tool()
    async def get_object_versions(workspace_id: str, object_id: str = "", object_path: str = "") -> list[dict]:
    ...
    @mcp.tool()
    async def extract_data_references(workspace_id: str, object_id: str, version: str = "") -> list[str]:
